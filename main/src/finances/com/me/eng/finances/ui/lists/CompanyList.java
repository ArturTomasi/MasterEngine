        ...
        AbstractList<Company>
{
    ...
    public String doContent( Company source )
    {
        ...
        sb.append( "<html>" )
          ...
          .append(      "<tr>" )
          .append(          "<td rowspan=\"4\">" )
          .append(              "<img style=\"width: 75px; padding: 0px 25px;\" src=\"" ).append( ResourceLocator.getFullImageResource( "finances/fi_company.png" ) ).append( "\">" )
          .append(          "</td>" )
          .append(      "</tr>" )
          .append(      "<tr>" )
          .append(          "<td style=\"vertical-align: top; padding-top: 10px\" colspan=\"2\">" )
          ...
          .append(      "</tr>" )
          .append(      "<tr>" )
          .append(          "<td style=\"padding-top: 10px\" colspan=\"2\">" )
